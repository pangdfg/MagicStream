...
func GetMovies(client *mongo.Client) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		var movieCollection *mongo.Collection = db.OpenCollection("movies", client)
...
func GetReviewRanking(admin_review string, client *mongo.Client, c *gin.Context) (string, int, error) {
	...
	base_prompt_template := env.GetString("BASE_PROMPT_TEMPLATE", "")
...
func GetRankings(client *mongo.Client, c *gin.Context) ([]models.Ranking, error) {
	...
	var rankingCollection *mongo.Collection = db.OpenCollection("rankings", client)
...
func GetRecommendedMovies(client *mongo.Client) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		recommendedMovieLimitStr := env.GetString("RECOMMENDED_MOVIE_LIMIT" , "5")
...
func GetUsersFavouriteGenres(userId string, client *mongo.Client, c *gin.Context) ([]string, error) {
	...
	var userCollection *mongo.Collection = db.OpenCollection("users", client)
...
func GetGenres(client *mongo.Client) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		var genreCollection *mongo.Collection = db.OpenCollection("genres", client)
